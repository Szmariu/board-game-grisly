...
```{r multi_plot, cache = TRUE, message = FALSE, echo = FALSE}
...
```{r animation, cache = TRUE, echo = FALSE}
...
## Board Game Geek is quite a „nerdy” place.
## Do less complex, „party” games get lower scores?
